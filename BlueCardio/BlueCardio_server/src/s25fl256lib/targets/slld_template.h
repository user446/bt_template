...
#define INCL_DUALOUTPUT_READ_4BCmd
#undef INCL_DORCmd
#undef INCL_4DORCmd
#define INCL_QUADOUTPUT_READCmd
#define INCL_QUADOUTPUT_READ_4BCmd
#undef INCL_QORCmd
#undef INCL_4QORCmd
...
#undef STATUS_IN_SR2 // for FLL
#undef BLOCK_PROTECT_USE_WRAR // for FLL
#undef BURSTWRAP_SIZE_1 // for FSS
#undef USE_4B_ADDR_BAR

// for command instruction
#undef CMD_RDSR2_35 // for FLK FL1K
#undef CMD_CLSR_82 // for FSS 256 512
#undef CMD_EPR_7A	// for FLL
#undef CMD_EPS_75 // for FLL
#undef CMD_SBL_77 // for FLL
#undef CMD_SE_20  // for FLL
#undef CMD_4SE_21 // for FLL
#undef CMD_PASSU_EA // for FLL
