...
#define THROUGHPUT_MAX_ATT_SIZE	(80)
...
#define ATT_VALUE_ARRAY_SIZE	(145 + OTA_ATT_VALUE_ARRAY_SIZE)
...
#define OPT_MBLOCKS	(10)	/*6:  for reaching the max throughput: ~220kbps (same as BLE stack 1.x)*/
